      ...
      <main className="max-w-6xl mx-auto px-5 sm:px-8 md:px-12 pb-16 pt-8">
        ...
        <section className="border-b border-bark/15 pb-8 mb-10">
          ...
          <p className="serif italic text-cocoa text-lg sm:text-xl mt-4 max-w-3xl leading-relaxed">
            ...
            this site. Fivetran lands CDC into Iceberg (MDLS), Snowflake / Athena / Trino
            read the same bytes, dbt Labs models bronze &rarr; silver &rarr; gold the moment
            each source sync finishes.
          </p>
        ...
        <section className="mb-10 border border-bark/15 bg-sand_2/40 rounded p-5">
          ...
          <p className="text-sm text-bark_2 leading-relaxed mb-6">
            Generated by dbt Labs from three Fivetran-synced sources &mdash; landed as Apache
            Iceberg (MDLS) on S3, then read by Snowflake / Athena / Trino against the same
            external catalog (no copies, no extracts). Fivetran Transformations triggers dbt
            Labs the moment the source sync finishes; bronze &rarr; silver &rarr; gold stays
            in Iceberg. Cortex Analyst reads the YAML semantic model &mdash; column
            descriptions, verified queries, allowed metrics &mdash; and translates
            plain-English questions into trusted SQL against these tables.
          </p>

          {/* Canonical pipeline flow */}
          <p className="ornament mb-3">Pipeline</p>
          <div className="mb-6 border border-bark/15 bg-sand/60 rounded p-4">
            <p className="mono text-[10px] tracking-widest uppercase text-cocoa leading-relaxed">
              Source &rarr; Fivetran &rarr; Iceberg (MDLS) &rarr; Snowflake / Athena / Trino
              &rarr; dbt Labs &rarr; React
            </p>
            <p className="serif text-bark_2 text-xs leading-snug mt-2">
              One copy of the bytes in open Apache Iceberg format. Snowflake, Athena, and
              Trino read the same Iceberg bytes via external catalogs &mdash; no extracts.
              dbt Labs is Fivetran-triggered.
            </p>
          </div>
